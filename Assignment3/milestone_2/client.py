...
# Server information
SERVER_HOST ="127.0.0.1" # "10.17.7.218" 
SERVER_PORT = 9801  
timeOut=0.03
...
def change_timeOut(clientsocket,current_rtt,currentRequest):
    ...
    # timeOut=(currentTime-previousTimeOutTime)/(currentRequest-previousRequest)
    # timeOut=(currentTime)/currentRequest
    # previousRequest=currentRequest
    # previousTimeOutTime=currentTime
...
def server_request(message,server_host,server_port,clientsocket,offset, requestNumber):
    ...
    while True:
        try:
            ...
            static_counter+=1
            # print(static_counter,"Timeout error#########################################################")
